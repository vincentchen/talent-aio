 ...
 *
 */
public class AioConfig<Ext, P extends Packet, R>
{
	/**
	 * 同时接受请求的并发数
	 */
	...
	public static final int threadPoolInitNum = Runtime.getRuntime().availableProcessors() * 1;

	public static final int threadPoolMaxNum = threadPoolInitNum * 4;

	public static final long threadPoolKeepAliveTime = 90L;
	 ...
	 * 
	 */
	public AioConfig(AioHandler<Ext, P, R> aioHandler)
	{
		super();
		this.aioHandler = aioHandler;

		SynchronousQueue<Runnable> decodePoolQueue = new SynchronousQueue<Runnable>();
		decodeExecutor = new SynThreadPoolExecutor<SynRunnableIntf>(threadPoolInitNum, threadPoolMaxNum, threadPoolKeepAliveTime, decodePoolQueue, "t-aio-decode");
		decodeExecutor.prestartAllCoreThreads();

		SynchronousQueue<Runnable> handlerPoolQueueHighPrior = new SynchronousQueue<Runnable>();
		handlerExecutorHighPrior = new SynThreadPoolExecutor<SynRunnableIntf>(threadPoolInitNum, threadPoolMaxNum, threadPoolKeepAliveTime, handlerPoolQueueHighPrior,
		...
		handlerExecutorLowPrior = new SynThreadPoolExecutor<SynRunnableIntf>(threadPoolInitNum, threadPoolMaxNum, threadPoolKeepAliveTime, handlerPoolQueueLowPrior,
		...
		sendExecutorHighPrior = new SynThreadPoolExecutor<SynRunnableIntf>(threadPoolInitNum, threadPoolMaxNum, threadPoolKeepAliveTime, sendPoolQueueHighPrior,
		...
		sendExecutorLowPrior = new SynThreadPoolExecutor<SynRunnableIntf>(threadPoolInitNum, threadPoolMaxNum, threadPoolKeepAliveTime, sendPoolQueueLowPrior,
	 ...
	 * 
	 */
	public AioConfig(AioHandler<Ext, P, R> aioHandler, SynThreadPoolExecutor<SynRunnableIntf> decodeExecutor, SynThreadPoolExecutor<SynRunnableIntf> handlerExecutorHighPrior,
