 ...
 * 
 */
package com.talent.aio.examples.client.handler;
...
import com.talent.aio.examples.common.im.Const;
import com.talent.aio.examples.common.im.ImPacket;
import com.talent.aio.examples.common.im.bs.JoinReqBody;
...
public class AuthRespHandler implements ImBsAioHandlerIntf
{
	...
	/** 
	 * @see com.talent.aio.examples.client.handler.ImBsAioHandlerIntf#handler(com.talent.aio.examples.common.im.ImPacket, com.talent.aio.common.ChannelContext)
	 * 
	 * @param packet
	...
	{
		JoinReqBody joinReqBody = new JoinReqBody(com.talent.aio.examples.client.ImClientStarter.groupid);
