 ...
 *
 */
public class DefaultServerAioListener<Ext, P extends Packet, R> implements ServerAioListener<Ext, P, R>
{
	 ...
	 */
	@Override
	public void onAfterConnected(ChannelContext<Ext, P, R> channelContext, boolean isConnected, boolean isReconnect)
	{}
	 ...
	 */
	@Override
	public void onAfterSent(ChannelContext<Ext, P, R> channelContext, P packet, boolean isSentSuccess)
	{}
	 ...
	 */
	@Override
	public void onAfterClose(ChannelContext<Ext, P, R> channelContext, Throwable throwable, String remark, boolean isRemove)
	{}
...
//	 */
//	@Override
//	public boolean onAfterAccepted(AsynchronousSocketChannel asynchronousSocketChannel, AioServer<Ext, P, R> aioServer)
//	{
