 ...
 */
class ChannelContextSetWithLock<Ext, P extends Packet, R>
{

	/** remoteAndChannelContext key: "ip:port" value: ChannelContext. */
	private ObjWithLock<Set<ChannelContext<Ext, P, R>>> setWithLock = new ObjWithLock<Set<ChannelContext<Ext, P, R>>>(new HashSet<ChannelContext<Ext, P, R>>());
	 ...
	 * @return the map
	 */
	public ObjWithLock<Set<ChannelContext<Ext, P, R>>> getSetWithLock()
	{
		return setWithLock;
	}
